...
#define CUSTOM_MACHINE_NAME "JGAurora A3S ROMEO"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // JGAurora A3S (tuned at 200C on an A3S)P48.11 I4.93 D117.24 C0 L0
  #define  DEFAULT_Kp 48.11//22.2
  #define  DEFAULT_Ki 4.93//1.08
  #define  DEFAULT_Kd 117.24//114
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // JGAurora A3S (tuned at 45C on an A3S)  
  #define  DEFAULT_bedKp 31.43
  #define  DEFAULT_bedKi 5.90
  #define  DEFAULT_bedKd 111.56
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 108 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 7, 90 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 7, 35 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 80, 8000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 11, 38, -.55 }
...
#define Z_PROBE_SPEED_FAST 130

// Feedrate (mm/m) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW 40
